...
public class IdentityService : IIdentityService
{
        ...
        string nombreTenant, string email, string password)
    {
        ...
        // 1) Crear el Tenant (la "casita" del negocio)
        ...
        // 2) Crear el usuario, ya asociado a ese Tenant
        ...
        // 3) Asegurar que el rol "Owner" exista, y asignarselo
        ...
        // 4) Generar el token ya con TenantId y rol incluidos
